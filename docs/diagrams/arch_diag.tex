...
% Title (Renamed for Generic README)
\node (top_label) [font=\bfseries\large, color=lineColor] {MICRO-CUDA V2.0 ARCHITECTURE (SIMT CORE)};
...
\node (frontend) [module, below=0.4cm of top_label] {
    ...
    {\footnotesize Fetch 32-bit Inst (Global Bus) $\rightarrow$ Local FIFO Decode}
};
